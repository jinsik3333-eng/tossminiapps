...
const beginnerQuestions = [
  ...
  makeQuestion("beginner", 32, "이 앱의 퀴즈 목적에 가장 맞는 것은?", ["주식 용어와 원리를 배우기", "특정 종목의 매수 시점을 받기"], 0, "이 앱은 교육용 상식 게임이야.", "policy", "binary"),
...
const advancedQuestions = [
  ...
  makeQuestion("advanced", 10, "단기 급등 후 변동성이 커질 때 위험 관리는 어떻게 접근할까?", ["진입가, 손실 한도, 비중을 미리 정한다", "상승 추세만 믿고 비중을 늘린다", "손절 기준 없이 평균단가만 낮춘다", "거래량이 늘면 계획을 생략한다"], 0, "계획 없는 속도전은 미니게임에서도 위험해.", "risk"),
