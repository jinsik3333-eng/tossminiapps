    ...
    return (
      <main className="app">
        ...
        <section className="routine-ticket">
          ...
          <p>
광고를 보면 오늘 바로 쓸 수 있는 앱 안 보상 루틴이 열려요.
          </p>
          ...
          {routineOpen ? (
            ...
            <Button onClick={openRoutine}>AD 보고 정리 보상 받기</Button>
          )}
        </section>
        ...
        <RewardHub
          appLabel="구독료 유령 찾기"
          pointsLabel={`${history.length * 5}P 모았어요`}
          primaryLabel="광고 보고 구독 정리 루틴 받기"
          questLabel="오늘 유령 단서 모으기"
          questProgress={homeClueCount}
          questTotal={3}
        ...
        <ResultActionMenu
          items={[
            ...
            { label: "친구 추천하고 보상 받기", onClick: shareWithReward },
