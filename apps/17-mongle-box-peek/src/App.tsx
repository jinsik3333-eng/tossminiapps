...
const APP_SLUG = "mongle-box-peek";
...
const THEME: Theme = {
  ...
  accent: "#F0A32D",
  soft: "#FFF0D4",
  opening: "광고 칸이 살롱 앞에 늘 열려 있어요.",
  motif: "상자",
  hero: "상자를 톡 열어보는 한 화면",
  heroNote: "페이지가 바뀌지 않아서 광고 칸도, 본 터치도 계속 앞에 있어요.",
  tapLines: [
  "상자 끈이 조금 풀렸어요.",
  "안쪽에서 반짝이 들었어요.",
  "뚜껑이 한 번 더 들썩였어요.",
  ...
  slots: [
  {
    "label": "리본",
    "title": "리본 칸",
    "note": "리본 칸을 눌러 상자 흐름을 다시 고를 수 있어요."
  },
  {
    "label": "뚜껑",
    "title": "뚜껑 칸",
    "note": "뚜껑 칸은 바로 다시 탭 가능한 광고 자리예요."
  },
  {
    "label": "선물",
    "title": "선물 칸",
    "note": "선물 칸은 열어두고 계속 누를 수 있어요."
  }
],
  focusTitle: "오늘의 상자",
  focusNote: "광고를 피하지 않고, 같은 화면에서 바로바로 누를 수 있게 설계했어요.",
  summary: "상자",
};
