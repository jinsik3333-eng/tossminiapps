...
const APP_SLUG = "mongle-stamp-atelier";
...
const THEME: Theme = {
  ...
  accent: "#F07A3F",
  soft: "#FFE6D7",
  opening: "광고 칸이 항상 보이는 작업실이에요.",
  motif: "도장",
  hero: "도장을 찍듯 한 번씩 눌러 채우는 작업실",
  heroNote: "한 번 눌러 액션이 끝나고, 광고 칸은 늘 같은 자리예요.",
  tapLines: [
  "도장 하나가 더 찍혔어요.",
  "잉크가 말랑하게 퍼졌어요.",
  "종이가 한 장 더 채워졌어요.",
  ...
  slots: [
  {
    "label": "우표",
    "title": "우표 칸",
    "note": "우표 칸을 다시 눌러 연속 도장을 이어가요."
  },
  {
    "label": "잉크",
    "title": "잉크 칸",
    "note": "잉크 칸은 반복 탭을 위한 광고 자리예요."
  },
  {
    "label": "종이",
    "title": "종이 칸",
    "note": "종이 칸을 열면 바로 다음 터치가 이어져요."
  }
],
  focusTitle: "오늘의 도장판",
  focusNote: "광고 칸과 본 터치가 분리되지 않도록 한 화면에 같이 둡니다.",
  summary: "도장",
};
